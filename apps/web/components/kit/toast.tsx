 ...
 * ease-out entrance (no overshoot). Positioned bottom-right.
 *
...
export function Toaster() {
  return (
    <SonnerToaster
      ...
      toastOptions={{
        // The shell: surface card, default (info-ish) accent edge, ease-out pop
        // (no overshoot). Type variants below override the left border colour.
        classNames: {
          toast:
